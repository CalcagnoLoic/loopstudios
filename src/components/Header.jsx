...
const Header = () => {
    return (
        <header className="h-screen bg-no-repeat bg-cover sm:h-[600px] sm:w-full z-40">
            <Navbar />
            <div className="p-5 py-52 sm:py-10 sm:px-16 md:px-32 xl:px-40 flex justify-center md:justify-start">
